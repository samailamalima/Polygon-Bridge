...
contract MaliNFT is ERC721A{
    ...
    string baseUrl = "https://gateway.pinata.cloud/ipfs/QmbhzuWuyYicC9Qj7xS2Q49QY2tkhiBXydYV3u1NtTgHet/";

    // URL for the prompt description
    string public PROMPT_NAME =
        "image of a single woman in a riot scene in Nigeria";

    constructor() ERC721A("MaliNFT", "mulmod(x, y, k)T") {
        owner = msg.sender;
    }
