...
describe("MalimaNFT", function () {
  ...
  beforeEach(async function () {
    ...
    // Deploy contract
    const MalimaNFT = await ethers.getContractFactory("MalimaNFT");
    contract = await MalimaNFT.deploy();
  ...
  it("should set the correct prompt description", async function () {
    expect(await contract.promptDescription()).to.equal(
      "https://gateway.pinata.cloud/ipfs/QmbhzuWuyYicC9Qj7xS2Q49QY2tkhiBXydYV3u1NtTgHet"
    );
  });
