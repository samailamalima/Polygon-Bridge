...
const ABI = require("../artifacts/contracts/MaliNFT.sol/MaliNFT.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("MaliNFT");
  const nft = await NFT.attach("0xfD973848FFFD188838340e8fdd0f830e32d47D4C");
